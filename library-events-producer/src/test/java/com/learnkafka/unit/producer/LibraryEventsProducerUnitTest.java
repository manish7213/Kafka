...
import com.learnkafka.constant.LibraryEventConstants;
...
public class LibraryEventsProducerUnitTest {
    ...
    void sendLibraryEvent_Approach2_success() throws JsonProcessingException, ExecutionException, InterruptedException {
        ...
        ProducerRecord<Integer, String> producerRecord = new ProducerRecord<>(LibraryEventConstants.TOPIC, libraryEvent.getLibraryEventId(), record);

        RecordMetadata recordMetadata = new RecordMetadata(
                new TopicPartition(LibraryEventConstants.TOPIC, 1),
